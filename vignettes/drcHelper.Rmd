...
```{r prelim-plot, fig.alt="Preliminary plot of dose-response data showing response vs. dose, with individual points and summary statistics."}
data("dat_medium")
...
```{r plot-models, fig.alt="Plot of three dose-response models fitted to the same data, showing the different curve shapes."}
...
```{r plot-ecx, fig.alt="Dose-response plot with EC10, EC20, and EC50 values and their confidence intervals indicated on the graph."}
