...
```{r}
#| fig.alt: >
#|   Scatter plot and fitted curves of a biphasic dose-response model
#| fig.cap: >
#|   Scatter plot and fitted curves of a biphasic dose-response model
#| fig.align: "center"
#| out.width: "70%"
...
```{r}
#| fig.alt: >
#|   fitted against residuals for Zn data in the metaldata
data(metaldata)
...
```{r}
#| fig.alt: >
#|   fitted against residuals for Zn data in the metaldata with Box-Cox transformation
...
```{r}
#| fig.alt: >
#|   fitted against residuals for Zn data in the metaldata with lgaussian function
#lgaussian function
