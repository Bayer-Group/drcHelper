...
There are people with opinions that many populaer normality tests, including Shapiro-Wilk's and Anderson-Darling tests should never be used. However, it is still useful to use these tests to quantify or identify non-normality, especially with moderate sample size.  
