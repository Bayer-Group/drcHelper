...
This article demonstrates how to use nls function to fit a dose-response model, taken from ggprism package.
...
library(ggplot2)
library(ggprism)
#> Error in library(ggprism): there is no package called 'ggprism'
library(ggnewscale)
