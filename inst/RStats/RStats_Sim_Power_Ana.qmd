...
source("~/Projects/drcHelper/inst/RStats/RStats_responsePattern.R", echo=TRUE)
...
plot_variance_patterns <- function(n_doses = 5, base_variance = 4, dose_range=NULL) {
  ...
  plot_data$Pattern <- gsub("_","-",plot_data$Pattern)
  # Create plot
...
publication_theme_12 <- function(base = theme_minimal()) {
  base + theme(
...
p1+p2 & plot_annotation(tag_levels = 'A') + publication_theme_12()
ggsave(file.path(here::here(),"inst/RStats/Revision/Figure_1_respnse_variance_pattern.png"),dpi = 300,width = 7.5,height = 4)
ggsave(file.path(here::here(),"inst/RStats/Revision/Figure_1_respnse_variance_pattern.pdf"),dpi = 300,width = 7.5,height = 4)
ggsave(file.path(here::here(),"inst/RStats/Revision/Figure_1.pdf"),dpi = 300,width = 7.5,height = 4)
```
