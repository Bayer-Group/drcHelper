...
test_JT_sim_1 <- run_hetero_variance_simulation(
  n_sim = 1000,  # Small number for testing
  n_doses = 7,
  m_tanks = 4,
  variance_pattern = c(2,2,2,2,2,10,4),
  max_effect = 5,
...
saveRDS(test_JT_sim_1 ,file="test_JT_sim_1.rds")

test_JT_sim_2 <- run_hetero_variance_simulation(
  n_sim = 1000,  # Small number for testing
  n_doses = 7,
  m_tanks = 4,
  variance_pattern = c(2,2,2,2,2,10,4),
...
saveRDS(test_JT_sim_2 ,file="test_JT_sim_2.rds")
plotit <- FALSE
if(plotit){
  ...
  # Plot test results
  test_plot <- plot_hetero_variance_results(test_JT_sim_1)
  print(test_plot)
