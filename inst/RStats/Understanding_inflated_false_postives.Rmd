# Understanding False Positives in CRD and RCBD Designs: A Mathematical Decomposition

One often encountered error in practice is the labeling of replicates, which can cause the random effect being modelled as a block effect. 
