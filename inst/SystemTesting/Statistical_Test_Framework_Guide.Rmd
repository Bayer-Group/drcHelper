...
if(file.exists("config/test_framework_config.R")) {
  ...
  cat("Configuration file not found. Please ensure you're in the correct directory.\n")
}
```
...
if(exists("TOLERANCE_SETTINGS")) {
  ...
  cat("Configuration not loaded. Tolerance settings not available.\n")
}
```
