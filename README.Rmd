...
The goal of drcHelper is to assit the routine dose-response analysis with a collection of helper functions or standalong functions that are generic and might be useful outside our own organization.
...
- Please create a pull request to contribute to the development of packages. 
