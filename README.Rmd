...
The goal of drcHelper is to assist the routine dose-response analysis with a collection of helper functions or standalone functions that are generic and might be useful outside our own organization.
